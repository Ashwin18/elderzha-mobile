...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Future<void> _load() async {
    ...
    setState(() {
      ...
      _notificationCount = _extractList(results[2], [
        'data',
        'notifications',
        'today',
        'unread',
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Container(
        ...
        child: Column(
          children: [
            // Photo — plain header photo, no text overlaid on it.
            SizedBox(
              height: 170,
            ...
            // Identity block — avatar (tap to upload/change via Edit
            // Profile), name, and phone number, centered below the
            // header photo.
            Padding(
                      ...
                      children: [
                        Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            border: Border.all(color: AppColors.bgCard, width: 4),
                          ),
                              ...
                              child: Column(
                                children: [
                                  ...
                                  _menuRow(
                                    ...
                                    valueColor: myBirthday.trim().isEmpty
                                        ? AppColors.inkLight
                                        : AppColors.purple,
                                  ),
                                  _menuRow(
            ...
            child: Row(
              children: [
                ...
                Icon(
                  ...
                  size: 16,
                  color: isRed ? AppColors.red : AppColors.inkLight,
                ),
              ],
            ),
          ),
